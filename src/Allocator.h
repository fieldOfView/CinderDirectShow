...
public:
	...
	// Mine
	typedef boost::signals2::signal<void( CAllocator* )> CiSignal;
	CiSignal*		GetSignal() { return &_signal; }; // Notice we return a pointer to the signal

	ci::Surface		GetCiSurface() { return mCiSurface; };
...
private:
	...
	CiSignal				_signal;
	ci::Surface				mCiSurface;

	HRESULT MakeCinderSurface( IDirect3DDevice9* aD3dDevice, IDirect3DTexture9* aTexture );
